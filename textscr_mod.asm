...
ScrollText	    		db		"Accdb Password Get 5.12 Keygen by sabYn [PRF]                                                               "
			    	db		"V2m by Oskar , GFX by r0ger , protection : MD5                                                                  "                 
			    	db		"Greetz to my bro r0ger, r0bica , B@TRyNU , WeeGee , MaryNello , ShTEFY , GRUiA , yMRAN , pHane , PuMMy , zzLaTaNN , DAViD , ShoGunu` , and other PRF memberz and all my friendz :3)                                        ",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,1
		mov scr.scroll_y,251
		
		mov scr.scroll_width,338
